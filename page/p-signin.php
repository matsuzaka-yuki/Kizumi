            ...
            <div class="row justify-content-center">
               <div class="w-100 align-self-end col-12">
                  <div class="text-center mb-3">
                     <a href="<?php echo get_option('home'); ?>"><?php kizumi_logo(); ?></a>
                     <h2 class="mb-1">欢迎回来</h2>
                     <p class="mb-0">
                        如果你还没有账号可以点击
                        <a href="<?php echo kizumi_sign_up_link_page(); ?>" class="text-primary">注册</a>
                     </p>
                  </div>
                  <form class="needs-validation mb-6" action="" method="post" id="loginform" novalidate>
                     ...
                     <div class="mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                           ...
                           <div><a href="<?php echo kizumi_reset_password_link_page(); ?>" class="text-primary">忘记密码</a></div>
                        </div>
                     </div>
                  ...
                  <div class="text-center mt-7">
                     <div class="small mb-3 mb-lg-0 text-body-tertiary">
                        ...
                        | Theme by
                        <span class="text-primary"><a href="https://www.mysqil.com">kizumi</a></span> powered by WordPress
                     </div>
                  </div>
               </div>
            </div>
         </div>
         <div class="position-fixed top-0 end-0 w-50 h-100 d-none d-lg-block vh-100" style="background-image: url(<?php echo get_kizumi('kizumi_user_login_bg')? get_kizumi('kizumi_user_login_bg') :'https://api.www.mysqil.com/random.php'; ?>); background-position: center; background-repeat: no-repeat; background-size: cover;transform: skewX(-10deg);right:-8rem!important;">
         </div>
      </div>
