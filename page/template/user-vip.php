        ...
        <?php if($erphp_day_price): ?>
                    ...
                    <div class="vip-card card h-100 border-0 shadow-hover">
                        <div class="card-body text-center p-4">
                            <div class="vip-level mb-3">
                                <img src="<?php echo kizumi_theme_url(); ?>/assets/images/vip/v2.png">
                            </div>
            ...
            <div class="col-lg-4">
                <div class="vip-card card h-100 border-0 shadow-hover">
                    <div class="card-body text-center p-4">
                        <div class="vip-level mb-3">
                            <img src="<?php echo kizumi_theme_url(); ?>/assets/images/vip/v3.png">
                        </div>
            ...
            <div class="col-lg-4">
                <div class="vip-card card h-100 border-0 shadow-hover">
                    <div class="card-body text-center p-4">
                        <div class="vip-level mb-3">
                            <img src="<?php echo kizumi_theme_url(); ?>/assets/images/vip/v4.png">
                        </div>
            ...
            <div class="col-lg-4">
                <div class="vip-card card h-100 border-0 shadow-hover">
                    <div class="card-body text-center p-4">
                        <div class="vip-level mb-3">
                            <img src="<?php echo kizumi_theme_url(); ?>/assets/images/vip/v5.png">
                        </div>
            ...
            <div class="col-lg-4">
                <div class="vip-card card h-100 border-0 shadow-hover">
                    <div class="card-body text-center p-4">
                        <div class="vip-level mb-3">
                            <img src="<?php echo kizumi_theme_url(); ?>/assets/images/vip/v6.png">
                        </div>
