...
?>
                <div class="col-lg-3 col-md-4">
                  <div class="d-flex align-items-center mb-4 justify-content-center justify-content-md-start">
                     <img src="<?php echo kizumi_get_avatar_url($current_user->ID,100); ?>" alt="avatar" class="avatar avatar-lg rounded-circle">
                     <div class="ms-3">
