                    ...
                    <div class="single-category">
                        ...
                        if (!empty($categories)) {
                            foreach ($categories as $category) { ?>
                                <a href="<?php echo esc_url(get_category_link($category->term_id)); ?>" title="查看《<?php echo esc_attr($category->name); ?>》分类下的所有文章" class="tag-cloud" rel="category tag">
                                    <i class="tagfa fa fa-dot-circle-o"></i><?php echo esc_html($category->name); ?>
                                </a>
                            <?php }
                        } ?>
                      </div>
                      ...
                      if ($tags) {
                        foreach ($tags as $tag) {
                          ...
                          echo '<i class="tagfa fa fa-tag"></i>';
                          echo $tag_name;
                          echo '</a> ';
                          }
                      }
