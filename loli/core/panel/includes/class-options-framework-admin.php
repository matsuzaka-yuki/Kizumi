     ...
     */
	 function options_page() { ?><?php $menu = $this->menu_settings(); ?>
	  ...
	  <?php settings_errors( 'options-framework' ); ?> 
		...
		<a href="https://www.mysqil.com/706.html" target="_blank" rel="external nofollow" class="el-button">
...
var kizumi_version = function () {
    var dboxElement = document.getElementById("dbox");
    dboxElement.innerHTML = "获取中...";
    fetch("https://doc.www.mysqil.com/wp-json/themes/v1/version/Kizumi")
