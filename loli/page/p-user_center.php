...
function kizumi_user_moneyto() {
   ...
   function kizumi_vip_name() {
      ...
      function kizumi_vip_pic() {
         $userTypeId=getUsreMemberType();
         if($userTypeId==6) {
            echo '<img src="'.kizumi_theme_url().'/assets/images/vip/v2.png">';
         } elseif($userTypeId==7) { 
            echo '<img src="'.kizumi_theme_url().'/assets/images/vip/v3.png">';
         } elseif ($userTypeId==8) {
            echo '<img src="'.kizumi_theme_url().'/assets/images/vip/v4.png">';
         } elseif ($userTypeId==9) {
            echo '<img src="'.kizumi_theme_url().'/assets/images/vip/v5.png">';
         } elseif ($userTypeId==10) {
            echo '<img src="'.kizumi_theme_url().'/assets/images/vip/v6.png">';
         } else {
            echo '<img src="'.kizumi_theme_url().'/assets/images/vip/v1.png">';
         }
         }       
function kizumi_vip_time() {	
   $userTypeId=getUsreMemberType();
   if($userTypeId) {
...
echo '<link rel="stylesheet" href="'.kizumi_theme_url().'/assets/css/user_center.css">';
...
?>
   <?php if(function_exists( 'mobantu_erphp_menu' )  ) {?>
    <section class="py-lg-7 py-5 user_center">
                        ...
                        <div class="mb-3 d-lg-flex align-items-center justify-content-between">
                           ...
                           <div class="mt-3 mt-lg-0 d-md-flex">
                              <?php if(get_option('ice_ali_money_checkin')):?>
                                 ...
                                 <?php else:?>
                                    <a href="javascript:;" id="kizumi-checkin-today" class="btn btn-outline-primary me-2">今日签到</a>
                                 <?php endif;?>
                              <?php endif;?>
                                 ...
                                 <tbody>
                                    <tr>
                                       <th scope="row">
                                          ...
                                          <img id="user-avatar"  src="<?php echo kizumi_get_avatar_url($current_user->ID,100); ?>"  class="avatar rounded-3 img-fluid" alt="avatar">  
                                             <div class="ms-3">
                                                ...
                                                <small>会员等级：<?php echo kizumi_vip_name(); ?> <?php echo kizumi_vip_pic(); ?> 到期时间：<?php echo kizumi_vip_time(); ?></small>
                                             </div>
                                             <div class="ms-3">
      ...
      <?php }else{ ?> 
         <section class="kizumi_user_center fadein-bottom">
            <div class="container">
               <div class="row">            
            <div class="user-info card">
				...
				<div class="alert alert-warning d-flex align-items-center" role="alert">
  				<span class="alert-icon"><i class="fa fa-bell"></i></span>
   				<span class="alert-text"> 提示：会员中心必须配套Erphpdown插件使用，检测网站未启用或者未安装该插件！
               <a href="https://docs.kizumi.mysqil.com" target="_blank" style="font-weight: bold;font-size: 15px;">从文档获取插件</a></span>
				</div>
				</div>
				</div>				
				</div>				
...
get_footer();
?>  
<script type="text/javascript" src="<?php echo kizumi_theme_url(); ?>/assets/js/user_center.js"></script>
